...
class Duck:
    ...
    def set_fly_behavior(self, fly_behavior: AbstractFlyBehavior) -> None:
        self.fly_behavior = fly_behavior

    def set_quack_behavior(self, quack_behavior: AbstractQuackBehavior) -> None:
        self.quack_behavior = quack_behavior
...
if __name__ == "__main__":
    d1 = MallardDuck()
    d1.perform_fly()
    d1.set_fly_behavior(fly_behavior=FlyNoWay())
    d1.perform_fly()
    d1.perform_quack()
